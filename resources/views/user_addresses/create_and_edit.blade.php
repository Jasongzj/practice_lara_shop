                ...
                <div class="card-body">
                    ...
                    <user-addresses-create-and-edit inline-template>
                        ...
                        @endif
                            ...
                            <div class="form-group row">
                                <label for="" class="col-form-label text-md-right col-sm-2">邮政编码</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="zip" value="{{ old('zip', $address->zip) }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-form-label text-md-right col-sm-2">联系人</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="contact_name" value="{{ old('contact_name', $address->contact_name) }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="" class="col-form-label text-md-right col-sm-2">联系方式</label>
                                <div class="col-sm-9">
